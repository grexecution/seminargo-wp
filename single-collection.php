...
<div id="primary" class="content-area collection-single">
    <main id="main" class="site-main">
        ...
        <!-- Location Finder CTA Section (same as home page) -->
        <section class="location-finder-cta">
            <div class="container">
                <div class="cta-content">
                    <div class="cta-text">
                        <h2><?php esc_html_e( 'Kostenlose Beratung für Ihre perfekte Location', 'seminargo' ); ?></h2>
                        <p><?php esc_html_e( 'Sparen Sie Zeit und Nerven – unser Expertenteam findet für Sie die ideale Location. Persönliche Beratung, maßgeschneiderte Vorschläge, 100% kostenfrei.', 'seminargo' ); ?></p>
                    </div>
                    <div class="cta-actions">
                        <a href="tel:+431290858" class="button button-white">
                        ...
                        <a href="mailto:info@seminargo.com" class="button button-outline-white">
                            ...
                            <?php esc_html_e( 'E-Mail senden', 'seminargo' ); ?>
                        </a>
                    </div>
                </div>
            </div>
